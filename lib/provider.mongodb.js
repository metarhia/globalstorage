...
module.exports = (api) => {
  ...
  api.gs.MongodbProvider = MongodbProvider;
  api.util.inherits(MongodbProvider, api.gs.StorageProvider);
  ...
  MongodbProvider.prototype.open = function(options, callback) {
    const provider = this;
    api.gs.StorageProvider.prototype.open.call(provider, options, () => {
  ...
  MongodbProvider.prototype.select = function(query, options, callback) {
    ...
    */
    if (callback) {
      ...
      const mс = new api.gs.MongodbCursor(this, cursor);
